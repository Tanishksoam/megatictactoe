...
import {circle,darkcross} from "../assets/images"
  ...
  const handleClick = () => {
    ...
    d.innerHTML =
      store.getState().count % 2 === 0
        ? `<img src=${darkcross} alt=X class=' w-8 h-8 top-2 justify-center items-center absolute'>`
        : `<img src=${circle} alt='O' class=' w-8 h-8 top-2 justify-center items-center absolute'> `
    ...
    if (winner === null) {
      ...
      win.innerHTML =
        winner === "X"
          ? `<img src=${darkcross} alt='X' class=' w-24 h-24 top-10 justify-center items-center absolute'>`
          : `<img src=${circle} alt ='O' class=' w-24 h-24 top-10 justify-center items-center absolute'> `;
